...
const Blacksmithing = () => {
  ...
  return (
    <section id="blacksmithing" ref={ref} className="py-16 md:py-20 bg-white">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-12 items-center">
          ...
          >
            <h2 className="text-3xl md:text-5xl font-bold text-[#17382f] mb-6">الحدادة</h2>
          ...
          <motion.div
            ...
            className="relative"
          >
            <img className="rounded-lg shadow-xl w-full h-[350px] md:h-[500px] object-cover" alt="أعمال الحدادة والأبواب الحديدية" src="https://images.unsplash.com/photo-1597126730092-4b15925ad79e" />
          </motion.div>
        </div>
      </div>
    </section>
